...
def test_output_type_deserialization_nested():
    ...
    assert deserialize_type("typing.List[typing.Dict[str, int]]") == list[dict[str, int]]
    # builtins
...
def test_output_type_serialization_haystack_dataclasses():
    ...
    assert serialize_type(dict[int, Answer]) == "typing.Dict[int, haystack.dataclasses.answer.Answer]"
    # Bytestream
    ...
    assert serialize_type(dict[int, ByteStream]) == "typing.Dict[int, haystack.dataclasses.byte_stream.ByteStream]"
    # Chat Message
    ...
    assert serialize_type(dict[int, ChatMessage]) == "typing.Dict[int, haystack.dataclasses.chat_message.ChatMessage]"
    # Document
    ...
    assert serialize_type(dict[int, Document]) == "typing.Dict[int, haystack.dataclasses.document.Document]"
    # builtins
    # Answer
...
def test_output_type_deserialization_haystack_dataclasses():
    ...
    assert deserialize_type("typing.Dict[int, haystack.dataclasses.answer.Answer]") == dict[int, Answer]
    # ByteStream
    ...
    assert deserialize_type("typing.Dict[int, haystack.dataclasses.byte_stream.ByteStream]") == dict[int, ByteStream]
    # Chat Message
    assert deserialize_type("typing.List[haystack.dataclasses.chat_message.ChatMessage]") == list[ChatMessage]
    assert deserialize_type("typing.Dict[int, haystack.dataclasses.chat_message.ChatMessage]") == dict[int, ChatMessage]
    ...
    assert deserialize_type("typing.List[haystack.dataclasses.document.Document]") == list[Document]
    assert deserialize_type("typing.Dict[int, haystack.dataclasses.document.Document]") == dict[int, Document]
    # builtins
    # Answer
